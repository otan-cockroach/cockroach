...
func TestParseGeometry(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			GeometryFromEWKB(geopb.EWKB([]byte("\x01\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00\xf0\x3f\x00\x00\x00\x00\x00\x00\xf0\x3f"))),
			"",
			0,
		},
		{
			"0101000020E6100000000000000000F03F000000000000F03F",
			GeometryFromEWKB(geopb.EWKB([]byte("\x01\x01\x00\x00\x20\xe6\x10\x00\x00\x00\x00\x00\x00\x00\x00\xf0\x3f\x00\x00\x00\x00\x00\x00\xf0\x3f"))),
			"",
			4326,
		},
		{
		...
		{
			"SRID=3857;POINT(1.0 1.0)",
			GeometryFromEWKB(geopb.EWKB([]byte("\x01\x01\x00\x00\x20\x11\x0F\x00\x00\x00\x00\x00\x00\x00\x00\xf0\x3f\x00\x00\x00\x00\x00\x00\xf0\x3f"))),
			"",
			3857,
		},
		{
...
func TestParseGeography(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			"0101000000000000000000F03F000000000000F03F",
			GeographyFromEWKB(geopb.EWKB([]byte("\x01\x01\x00\x00\x20\xe6\x10\x00\x00\x00\x00\x00\x00\x00\x00\xf0\x3f\x00\x00\x00\x00\x00\x00\xf0\x3f"))),
			"",
			4326,
		},
		{
		...
		},
		{
			...
			GeographyFromEWKB(geopb.EWKB([]byte("\x01\x01\x00\x00\x20\x11\x0F\x00\x00\x00\x00\x00\x00\x00\x00\xf0\x3f\x00\x00\x00\x00\x00\x00\xf0\x3f"))),
			"",
			3857,
		},
		{
