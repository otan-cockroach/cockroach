...
func (ie *InternalExecutor) execInternal(
	...
	sdMutator := ie.s.makeSessionDataMutator(sd, nil /* defaults */, &internalClientCommBuffer{})
...
// BufferParamStatus is part of the pgwireconn.ClientConnBuffer interface.
...
// internalClientCommBuffer is an implementation of pgwire.ClientConnBuffer
// that does not do anything. This is intended for internal executors.
type internalClientCommBuffer struct{}

var _ pgwireconn.ClientConnBuffer = &internalClientCommBuffer{}

// BufferParamStatus implements the pgwire.ClientConnBuffer interface.
func (b *internalClientCommBuffer) BufferParamStatus(param, value string) error {
	return nil
}
