...
// FormatSeverity formats the severity field of an error.
// Namely, DEBUG<num> gets chopped off.
func FormatSeverity(err error) string {
	severity := pgerror.GetSeverity(err)
